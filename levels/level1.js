...
function createLevel1(world) {
    ...
    return new Level(
        ...
        [
            new BackgroundObject('img/3. Background/Layers/5. Water/D.png', -1919),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/D.png', -1919),
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/D.png', -1919),
            new BackgroundObject('img/3. Background/Layers/2. Floor/D.png', -1919),
